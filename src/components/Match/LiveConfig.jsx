...
export default function LiveConfig({ team1, team2, matchType, onBack, onMatchCreated }) {
  ...
  const team1Name = team1.map(p => p.name).join(' / ')
  const team2Name = team2.map(p => p.name).join(' / ')
